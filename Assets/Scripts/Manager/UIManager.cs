 ...
 * 文件名称：   UIManager.cs
 * 
 * 简    介:    UI模块的动态创建，回收，以及Mediator层的注册和移除 
 * 
 * 创建标识：   Pancake 2016/7/22 9:33:40
 * 
 * 修改描述：
 * 
 */
...
public class UIManager : Singleton<UIManager>
{
	...
	public override void Init ()
	{
        ...
        if (UIRootObj == null)
        {
            UIRootObj = MonoBehaviour.Instantiate(Resources.Load(UIPathDefines.GetPrefabPathByType(EnumUIType.UIRoot))) as GameObject;
